...
import { DEFAULT_THEME, THEME_INIT_SCRIPT, applyTheme, getStoredTheme } from "../lib/theme";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "AdVantage — Autonomous GTM Command Center" },
      ...
      { property: "og:title", content: "AdVantage — GTM-Zero" },
      { property: "og:description", content: "Your marketing team on demand. Five agents. One launch dashboard." },
    ],
    links: [
